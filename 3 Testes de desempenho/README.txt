...
#- 🛠️ Ferramentas Utilizadas
    -(Google Speed Insights): (https://pagespeed.web.dev/)

#- 📊 Resultado do Desempenho(Mobile)
    - Desempenho Geral = 81 ⚠️
...
#- 📊 Resultado do Desempenho(Desktop)
    ...
    - Cumulative Layout Shift = 0,187 ⚠️
    - Speed Index = 1,1s ✅

#- 📝 Conclusão(Desktop)
    - De forma geral o teste de desempenho se mostrou positivo, com um desempenho acima do aceitável
    - O ponto negativo é o Cumulative Layout Shift, deve ser otimizado para melhorar o desempenho geral
    - Não foi realizada a simulação de carga alta. Ao decorrer da navegação manual o sistema se manteve estável e flúido sem travamentos
